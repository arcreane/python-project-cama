...
def jeu_memoire():
    ...
    def draw_tile(screen, row, col, grid, revealed, reveal=False):
    ...
    def main(grid_size):
        ...
        symbols = ["\u2605", "\u2600", "\u2601", "\u2660", "\u2666", "\u2764", "\u266B", "\u273F",
                   "\u25B2", "\u25A0", "\u25C6", "\u25CF", "\u25E3", "\u2602", "\u2618", "\u2620",
                   "\u262F", "\u263A", "\u263C", "\u260E", "\u2663", "\u2721"]
        selected = symbols[:grid_size * grid_size // 2] * 2
        ...
        for row in range(grid_size):
            for col in range(grid_size):
                draw_tile(screen, row, col, grid, revealed, reveal=True)
        pygame.display.flip()
        time.sleep(3)
        ...
        while running:
            ...
            for row in range(grid_size):
                for col in range(grid_size):
                    draw_tile(screen, row, col, grid, revealed)
            pygame.display.flip()
